      ...
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        ...
        <div className='flex justify-center items-center'>
          ...
          <Typed
            ...
            strings={["JAVA", "JS", "C++", "HTML", "C", "CSS"]}
            typeSpeed={90}
            backSpeed={50}
            loop
          />
        </div>
        <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-4 text-black transition-all ease-linear duration-[550ms] hover:rounded-3xl hover:bg-[#0fa575]'>Get Started</button>
      </div>
    </div>
  );
};
